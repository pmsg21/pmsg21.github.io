...
export const showPortfolioModal = (title, imgName, projectUrlText, projectUrl, projectCodeUrlText, projectCodeUrl, projectDescriptionText, projectDescription) => {
    Swal.fire({
        title: `<h2>${title}</h2>`,
        html: `
            <img src="/assets/img/portfolio/${imgName}.png" alt="${imgName}" class="img-fluid d-block mb-4"/>
